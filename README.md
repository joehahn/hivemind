...
classifier can be used to drive the automated decision-making that code 
...
were mediocre at best, likely because the rewards generated by the hivemind game
...
rewards, and results in wiser gameplay recommendations.
